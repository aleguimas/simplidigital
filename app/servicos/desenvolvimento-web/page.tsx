                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="p-8 lg:p-12">
                    ...
                    <ul className="space-y-2 mb-6">
                      {(t('pages.serviceDetails.webDevelopment.caseStudy.features', { returnObjects: true }) as string[]).map((feature: string, index: number) => (
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="p-8 lg:p-12">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <p className="text-gray-700 italic">
                        &ldquo;O portal superou todas as expectativas, batendo recorde de participação e demonstrando a eficiência da solução desenvolvida pela Simplí Digital.&rdquo;
                      </p>
                      <p className="text-sm text-gray-600 mt-2">- Norma Selene Guimarães, Secretária Executiva de Planejamento e Gestão</p>
                    </div>
                  </div>
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-8">
                    <div className="text-center">
                      ...
                      <h4 className="text-xl font-semibold text-gray-900 mb-2">Resultados Impressionantes</h4>
                      <div className="grid grid-cols-2 gap-4 text-center">
                        <div>
                          <div className="text-2xl font-bold text-blue-600">+10 mil</div>
                          <div className="text-sm text-gray-600">Acessos únicos</div>
                        </div>
                        <div>
                          <div className="text-2xl font-bold text-indigo-600">40 mil</div>
                          <div className="text-sm text-gray-600">Respostas coletadas</div>
                        </div>
                      </div>
                      <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                        <div className="text-sm text-blue-800 font-medium">Recorde de cadastros batido!</div>
                      </div>
                    </div>
                  </div>
                </div>
