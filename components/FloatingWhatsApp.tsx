  ...
  return (
    ...
    >
      <button
        ...
        className="group relative text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-simpli-teal/30"
        style={{
      ...
      >
        ...
        {/* Efeito de pulso */}
        <div className="absolute inset-0 bg-simpli-teal rounded-full animate-ping opacity-20"></div>
